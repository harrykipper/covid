...
to go
  ...
  ask turtles with [infected?] [
    ...
    if (not symptomatic?) and (infection-length - infectivity-time > 3)  [set chance-of-infecting chance-of-infecting * 0.9]   ;;changed here that it starts declinning soone by 10% each additional day
    ...
    if symptomatic? and (should-test? self) and (infection-length = testing-urgency) [
      ...
      [get-tested]
      [maybe-isolate "symptomatic-individual"]
    ]
